...
## 3. 踩中地雷畫面 - 遊戲結束 (Mine! Game Over)
踩到地雷即 Game Over。中央彈出玻璃擬物化 (Glassmorphism) 卡片顯示 **「BUSTED」** 與 -$0.00，明確呈現炸彈圖示並強調押金沒收。
...
玩家選擇兌現時的勝利畫面。玻璃擬物化 (Glassmorphism) 卡片顯示 **「CASHED OUT」** 與總獎金金額，帶有鑽石圖示、詳細的打賞倍數與獲利金額。

...
const RTP_VALUES = [94, 96, 97, 98, 99];
...
// Part 1: 解析驗算
// ──────────────────────────────────────────────────────────────
function analyticalExpectedPayout(m, d, rtp) {
...
function runAnalyticalVerification(rtp) {
    let maxError = 0;
    let testedCases = 0;
...
// ──────────────────────────────────────────────────────────────
function simulateOneGame(mineCount, targetOpen, rtp) {
...
function runMonteCarlo(rtp, simulations = 500_000) {
...
console.log('='.repeat(70) + '\n');
//# sourceMappingURL=rtp-simulation.js.map